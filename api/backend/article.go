...
type ArticleCommonAddUpdate struct {
	UserId  int    `json:"user_id"    description:"this field is not match gfspv2" v:"required#名称必传"`
	...
	IsAdmin uint   `json:"is_admin"    d:"1"       description:"1后台管理员发布 2前台用户发布"`
...
type ArticleDeleteReq struct {
	g.Meta `path:"/backend/article/delete" method:"delete" tags:"文章" summary:"删除文章接口"`
	Id     uint `v:"min:1#请选择需要删除的文章" dc:"文章id"`
}
type ArticleDeleteRes struct{}

type ArticleUpdateReq struct {
	g.Meta `path:"/backend/article/update/" method:"post" tags:"文章" summary:"修改文章接口"`
...
type ArticleGetListCommonReq struct {
	g.Meta `path:"/backend/article/list" method:"get" tags:"文章" summary:"文章列表接口"`
	CommonPaginationReq
}
